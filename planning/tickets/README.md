...
| T-029 | PJ-01 star has no favorites endpoint | done |
...
| T-034 | Seeded blocks do not match the §2.6 props contract | done |
| T-035 | Trashed pages and issues stay in the search index | done |
